...
{
    public interface IStageController : IFeature
    {
        Vector3 DirX { get; }
        Vector3 DirZ { get; }
    ...
    public class StageController : AbstractCustomComponentBehaviour, IStageController
    {
        ...
        public override void Register(ICustomComponentCollection owner)
        {
            ...
            owner.RegisterInterface<IStageController>(this);
        }
