...
namespace HexRPG.Battle.Skill
{
    ...
    {
        void Init(IAttackComponentCollection attackOwner, IAnimationController animationController, PlayableAsset timeline, List<ActivationBindingData> activationBindingMap);
